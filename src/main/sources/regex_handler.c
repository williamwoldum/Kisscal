...
void setup_regex() {
    const char *expressions[num_input_rules] = {
        ...
        "^remove event '.{1,15}' (Monday|Tuesday|Wednesday|Thursday|Friday|Saturday|Sunday)\n",
        "^add assignment '.{1,15}' (Monday|Tuesday|Wednesday|Thursday|Friday|Saturday|Sunday) [0-9]{2}:[0-9]{2} ([0-9]{1,2}|[0-9]{1,2}.[0-9])\n",
        "^remove assignment '.{1,15}' (Monday|Tuesday|Wednesday|Thursday|Friday|Saturday|Sunday)\n",
